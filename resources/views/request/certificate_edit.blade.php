                    ...
                    <div class="col-md-12">
                        <div class="card table-card">
                            ...
                            <div class="card-block p-b-0">
                                <form action="/update_certificate/{{$form->sufferer_id}}" method="POST"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="text" class="form-control" placeholder="เลขหนังสือ/(พ.ศ.)"
                                                name="sufferer_no" value="{{$form->sufferer_no}}">
                                        </div>
                                        <div class="col-sm-2">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="date" class="form-control" name="sufferer_user_birte"
                                                value="{{$form->sufferer_user_birte}}">
                                        </div>
                                        <div class="col-sm-2">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" 
                                            placeholder="เลขประจำตัวประชาชน/หนังสือเดินทางเลขที่/อื่น ๆ (ถ้ามี)" 
                                            name="sufferer_userid" maxlength="13"
                                            value="{{$form->sufferer_userid}}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-1"></div>
                                        ...
                                        <div class="col-sm-4">
                                            <select name="subdistrict" class="form-control-sl" id="subdistrict">
                                                ...
                                                <option value="{{$item->subdistrict_id}}" @if($item->subdistrict_id ==
                                                    $form->subdistrict) {{"selected"}} @endif >
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <select name="home_province" class="form-control-sl" id="province1">
                                                ...
                                                @foreach ($pro as $item)
                                                <option value="{{$item->province_id}}" @if($item->province_id ==
                                                    $form->home_province) {{"selected"}} @endif>
                                                    {{$item->province_name}}
                                                </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <select name="home_district" class="form-control-sl" id="district1">
                                                ...
                                                @foreach ($dis as $item)
                                                <option value="{{$item->district_id}}" @if($item->district_id ==
                                                    $form->home_district) {{"selected"}} @endif >
                                                    {{$item->district_name}}
                                                </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-sm-4">
                                            <select name="home_subdistrict" class="form-control-sl" id="subdistrict1">
                                                ...
                                                @foreach ($sub as $item)
                                                <option value="{{$item->subdistrict_id}}" @if($item->subdistrict_id ==
                                                    $form->home_subdistrict) {{"selected"}} @endif >
                                                    {{$item->subdistrict_name}}
                                                </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-3">
                                            <select name="home_zipcode" class="form-control-sl" id="zipcode1">
                                                ...
                                                @foreach ($sub as $item)
                                                <option value="{{$item->zip_code}}" @if($item->zip_code ==
                                                    $form->home_zipcode) {{"selected"}} @endif>
                                                    {{$item->zip_code}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="date" class="form-control" name="sufferer_start_date"
                                                value="{{$form->sufferer_start_date}}">
                                        </div>
                                        <div class="col-sm-2">
                                            <input type="time" class="form-control" name="sufferer_start_time"
                                                value="{{$form->sufferer_start_time}}">
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" class="form-control" name="sufferer_user_position"
                                                value="{{$form->sufferer_user_position}}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-4"></div>
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" class="form-control" name="sufferer_user_director"
                                                value="{{$form->sufferer_user_director}}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-11">
