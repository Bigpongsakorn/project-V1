                                        ...
                                        <div class="col-md-12">
                                            <div class="card table-card">
                                                ...
                                                <div class="card-block p-b-0">
                                                    <form action="/insert_certificate_online" method="POST"
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-3">
                                                                <input type="text" class="form-control"
                                                                    placeholder="เลขหนังสือ/(พ.ศ.)" name="sufferer_no">
                                                            </div>
                                                            <div class="col-sm-2">
                                                            ...
                                                            <div class="col-sm-4">
                                                                <input type="text" class="form-control"
                                                                    placeholder="ส่วนราชการเจ้าของหนังสือ"
                                                                    name="sufferer_gover">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <div class="col-sm-1"></div>
                                                            <label
                                                                class="col-sm-3 col-form-label">หนังสือฉบับนี้ให้ไว้เพื่อรับรองว่า
                                                            </label>
                                                            <div class="col-sm-7">
                                                                <input type="text" class="form-control"
                                                                    name="sufferer_confirm">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <div class="col-sm-1"></div>
                                                            ...
                                                            <div class="col-sm-4">
                                                                <input type="text" class="form-control"
                                                                    placeholder="เลขประจำตัวประชาชน/หนังสือเดินทางเลขที่/อื่น
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-sm-1"></div>
                                                            <label
                                                                class="col-sm-3 col-form-label">ที่อยู่ที่ประสบสาธารณภัย
                                                                บ้านเลขที่</label>
                                                            <div class="col-sm-2">
                                                                <input type="text" class="form-control"
                                                                    name="sufferer_home_num" >
                                                            </div>
                                                            <label class="col-sm-1 col-form-label">หมู่ที่</label>
                                                            <div class="col-sm-4">
                                                                <input type="number" class="form-control"
                                                                    name="sufferer_home_no">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <div class="col-sm-1"></div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-4">
                                                                <select name="subdistrict" class="form-control-sl"
                                                                    id="subdistrict">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-3">
                                                                <select name="zip_code" class="form-control-sl"
                                                                    id="zipcode">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <label class="col-sm-1 col-form-label">จังหวัด</label>
                                                            <div class="col-sm-4">
                                                                <select name="home_province" class="form-control-sl"
                                                                    id="province1">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <label class="col-sm-1 col-form-label">อำเภอ</label>
                                                            <div class="col-sm-4">
                                                                <select name="home_district" class="form-control-sl"
                                                                    id="district1">
                                                            ...
                                                            <label class="col-sm-1 col-form-label">ตำบล</label>
                                                            <div class="col-sm-4">
                                                                <select name="home_subdistrict" class="form-control-sl"
                                                                    id="subdistrict1">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <label class="col-sm-2 col-form-label">รหัสไปรษณีย์</label>
                                                            <div class="col-sm-3">
                                                                <select name="home_zipcode" class="form-control-sl"
                                                                    id="zipcode1">
                                                                    <option value="opt1">เลือกรหัสไปรษณีย์</option>
                                                                </select>
                                                            </div>
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-sm-1"></div>
                                                            <label
                                                                class="col-sm-2 col-form-label">สถานที่เกิดภัย</label>
                                                            <div class="col-sm-8">
                                                                <input type="text" class="form-control"
                                                                    name="sufferer_loaction">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <div class="col-sm-1"></div>
                                                            ...
                                                            <div class="col-sm-4">
                                                                <input type="date" class="form-control"
                                                                    name="sufferer_start_date">
                                                            </div>
                                                            <div class="col-sm-2">
                                                                <input type="time" class="form-control"
                                                                    name="sufferer_start_time">
                                                            </div>
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-sm-1"></div>
                                                            <label
                                                                class="col-sm-8 col-form-label"><b>ความเสียหายของผู้ประสบภัย</b>
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-sm-11">
                                                                <div
                                                                    ...
                                                                    <a href="/download/fill">
                                                                        <button class="btn btn-secondary btn-form"
                                                                            type="button">
