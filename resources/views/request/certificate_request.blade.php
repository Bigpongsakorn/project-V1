                        ...
                        <div class="card">
                            ...
                            <div class="dt-responsive table-responsive">
                                <div class="card-block">
                                    <a href="/request/certificate_request_insert">
                                        ...
                                        <table id="order-table"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ date('d-m-Y',strtotime($item->guaranty_to_date)) }}</td>
                                                    <td>
                                                        <a href="{{url('PDF/certificate_request',$item->guaranty_id)}}"
                                                            class="btn btn-warning">
                                                            <span class="fa fa-print"></span> พิมพ์เอกสาร</a>
                                                    </td>
                                                    <td>
                                                        <a href="/request/certificate_request_edit/{{$item->guaranty_id}}"
                                                            class="btn btn-primary m-b-20"><span
                                                                class="fa fa-edit"></span> แก้ไข</a>
                                                    </td>
                                                    <td>
                                                        <form action="/destroy_certificate_request/{{$item->guaranty_id}}"
                                                            method="post">
                                                            @csrf
