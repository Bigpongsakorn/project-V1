                                            ...
                                            <div class="col-md-12">
                                                <div class="card table-card">
                                                    ...
                                                    <div class="card-block">
                                                        <form action="/insert_certificate_request_online" method="POST"
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <label
                                                                        class="col-form-label tb-ct">(ออกตามระเบียบกระทรวงมหาดไทย
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-8 checkbox-fade fade-in-primary">
                                                                    ...
                                                                    <label
                                                                        class="col-sm-3 col-form-label">ผู้ประสบภัย</label>
                                                                    <label>
                                                                    ...
                                                                    <label
                                                                        class="col-sm-3 col-form-label">เจ้าของทรัพย์สิน</label>
                                                                    <label>
                                                                    ...
                                                                    <label
                                                                        class="col-sm-3 col-form-label">ผู้ครอบครองทรัพย์สิน</label>
                                                                    <div class="col-sm-1"></div>
                                                                    <label>
                                                                    ...
                                                                    <input
                                                                        class="col-sm-12 form-text-checkbox other
                                                                        tposti1 posti"
                                                                        type="text" name="position_text" 
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-sm-1"></div>
                                                                <label
                                                                    class="col-sm-3 col-form-label">ได้รับผลกระทบจากเหตุการณ์</label>
                                                                <div class="col-sm-3">
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-sm-1"></div>
                                                                <label
                                                                    class="col-sm-8 col-form-label">โดยได้แนบเอกสารหลักฐานประกอบการพิจารณา
                                                                    ปรากฏดังนี้ (ใส่เครื่องหมาย <i
                                                                        class="fa fa-check"></i> ใน <i
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10 checkbox-fade fade-in-primary">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <div class="col-sm-1"></div>
                                                                        <div
                                                                            class="col-sm-10 checkbox-fade fade-in-primary">
                                                                            <label>
                                                                                <input type="radio" value="1" class="chk"
                                                                                    name="person">
                                                                                <span class="cr"><i
                                                                                        class="cr-icon icofont icofont-ui-check txt-primary"></i></span>
                                                                            </label>
                                                                            <label
                                                                                class="col-sm-11 col-form-label">บุคคลธรรมดา</label>
                                                                            <!-- ---- -->
                                                                            <div class="form-group row">
                                                                                <div class="col-sm-1"></div>
                                                                                <div
                                                                                    class="col-sm-9 checkbox-fade fade-in-primary">
                                                                                    <label>
                                                                                    ...
                                                                                    <label
                                                                                        class="col-sm-11 col-form-label">สำเนาบัตรประชาชน
                                                                                    ...
                                                                                    <label
                                                                                        class="col-sm-11 col-form-label">สำเนาทะเบียนพาณิชยน์
                                                                                        (ถ้ามี)</label>
                                                                                    <div class="col-sm-1"></div>
                                                                                    <label>
                                                                                        <input type="checkbox" value="1" class="ch1"
                                                                                    ...
                                                                                    <input
                                                                                        ...
                                                                                        type="text"
                                                                                        name="natural_person_text"
                                                                                        placeholder="อื่น ๆ (โปรดระบุ)">
                                                                                </div>
                                                                            </div>
                                                                            <!-- ---- -->
                                                                            <label>
                                                                                <input type="radio" value="2" class="chk"
                                                                                    name="person">
                                                                                <span class="cr"><i
                                                                                        class="cr-icon icofont icofont-ui-check txt-primary"></i></span>
                                                                            </label>
                                                                            <label
                                                                                class="col-sm-11 col-form-label">นิติบุคคล</label>
                                                                            <!-- ---- -->
                                                                            <div class="form-group row">
                                                                                <div class="col-sm-1"></div>
                                                                                <div
                                                                                    ...
                                                                                    <label
                                                                                        ...
                                                                                        อื่น ๆ</label>
                                                                                    <input
                                                                                        class="col-sm-7 form-text-checkbox other"
                                                                                        type="text" name="juristic_text"
                                                                                        placeholder="อื่น ๆ (โปรดระบุ)">
                                                                                </div>
                                                                            </div>
                                                                            <!-- ---- -->
                                                                    ...
                                                                    <label class="col-sm-2 col-form-label">๕. อื่น
                                                                        ๆ</label>
                                                                    <input class="col-sm-8 form-text-checkbox other"
                                                                        name="other_text"
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <label
                                                                    class="col-sm-1 col-form-label">ผู้ยื่นคำขอ</label>
                                                            </div><br>
                                                            <div class="form-group row">
                                                                <div class="col-sm-1"></div>
