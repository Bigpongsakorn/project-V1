                                        ...
                                        <table id="order-table"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ date('d-m-Y',strtotime($item->disaster_date)) }}</td>
                                                    <td>
                                                        <a href="{{url('PDF/certificate',$item->disaster_id)}}"
                                                            class="btn btn-warning">
                                                            <span class="fa fa-print"></span> พิมพ์เอกสาร</a>
                                                    </td>
                                                    <td>
                                                        <a href="/request/certificate_request_edit/{{$item->disaster_id}}"
                                                            class="btn btn-primary m-b-20"><span
                                                                class="fa fa-edit"></span> แก้ไข</a>
                                                    </td>
                                                    <td>
                                                        <form action="/destroy_certificate/{{$item->guaranty_id}}"
                                                            method="post">
                                                            @csrf
