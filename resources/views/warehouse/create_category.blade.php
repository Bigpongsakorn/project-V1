                        ...
                        <div class="card-block">
                            ...
                            <form action="/insertcategory" method="post">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">ชื่อประเภทอุปกรณ์ :</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="categoryw_name" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                            ...
                                            <a href="/warehouse/category"><button class="btn btn-secondary btn-form"
